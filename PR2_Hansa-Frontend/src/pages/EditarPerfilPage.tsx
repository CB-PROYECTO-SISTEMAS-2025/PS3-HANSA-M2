...
import { FiSave, FiX, FiUser, FiBook, FiHeart, FiEye, FiEyeOff, FiCamera } from "react-icons/fi";
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative group">
                    <input
                      className="w-full border-2 border-amber-300 bg-amber-50 rounded-xl p-3 cursor-not-allowed text-gray-600"
                      placeholder="Usuario"
                      value={username}
                      disabled
                    ...
                    />
                    {/* Tooltip on hover */}
                    <div className="absolute left-0 -top-16 bg-gray-800 text-white text-xs rounded-lg px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap shadow-lg z-10">
                      <div className="relative">
                        ⚠️ No se puede cambiar el username porque se utiliza para login
                        <div className="absolute -bottom-1 left-6 w-2 h-2 bg-gray-800 transform rotate-45"></div>
                      </div>
                    </div>
                  </div>
                </div>
